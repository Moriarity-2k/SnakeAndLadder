...
import {
	...
	GiInvertedDice5,
	GiInvertedDice6,
} from "react-icons/gi"; // Importing dice icons from react-icons

// PlayerIntro component: Manages the player turns and dice rolling
export function PlayerIntro({
	...
	// spinner to show , just for a little UI enhancement
