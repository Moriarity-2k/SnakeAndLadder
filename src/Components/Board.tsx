...
/**
 *
 * @returns Main Board component which holds the player intro and players as children
 */
export function Board() {
	...
	// Handling resize , to re validate the board height and with
	useEffect(() => {
	...
	// Rolls the dice and displays the notification in case of winning, ladder, snake
	function RollDice(randomNumber: number) {
		...
		setCurrentPlayer((prev) =>
			prev === Players.a ? Players.b : Players.a
		);
	}
